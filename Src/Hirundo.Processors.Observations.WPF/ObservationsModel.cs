...
public class ObservationsModel(ILabelsRepository repository) : ParametersBrowserModel<ObservationsParameters, IObservationCondition, ObservationsModel>(repository)
{
