...
public class CompareValuesModel<TCondition>(TCondition condition, ILabelsRepository repository) : ParametersModel(condition, repository) where TCondition : ICompareValueCondition
{
