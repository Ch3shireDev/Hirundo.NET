...
public class ComputedValuesModel(ILabelsRepository repository) : ParametersBrowserModel<ComputedValuesParameters, IComputedValuesCalculator, ComputedValuesModel>(repository)
{
