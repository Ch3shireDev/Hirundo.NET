...
public class ReturnsDisplayDataTests
{
    ...
    public void ReturningDataShowsOnlyFirstRecord()
    {
        ...
        {
            new() { Date = new DateTime(2021, 06, 01), Species="RUB.RUB", Ring="AB123", Headers=["D1", "D2"], Values=[1,2] },
            new() { Date = new DateTime(2021, 06, 02), Species="RUB.RUB", Ring="AB123", Headers=["D1", "D2"], Values=[3,4] },
        };
    ...
    public void ReturningDataShowsFirstRecordedObservation()
    {
        ...
        {
            new() { Date = new DateTime(2021, 06, 02), Species="RUB.RUB", Ring="AB123", Headers=["D1", "D2"], Values=[3,4] },
            new() { Date = new DateTime(2021, 06, 01), Species="RUB.RUB", Ring="AB123", Headers=["D1", "D2"], Values=[5,6] },
        };
