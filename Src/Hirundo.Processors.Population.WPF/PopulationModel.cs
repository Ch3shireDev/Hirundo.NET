...
public class PopulationModel(ILabelsRepository labelsRepository, ISpeciesRepository speciesRepository) : ParametersBrowserModel<PopulationParameters, IPopulationConditionBuilder, PopulationModel>(labelsRepository, speciesRepository)
{
