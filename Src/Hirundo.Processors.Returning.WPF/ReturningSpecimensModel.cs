...
public class ReturningSpecimensModel(ILabelsRepository repository) : ParametersBrowserModel<ReturningParameters, IReturningSpecimenCondition, ReturningSpecimensModel>(repository)
{
